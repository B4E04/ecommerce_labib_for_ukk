...
if (isset($_POST['tambah'])) {
    ...
    mysqli_query(
        $conn,
        "INSERT INTO petugas (nama,email,jabatan)
     VALUES ('$nama','$email','$jabatan')"
    );
...
if (isset($_GET['edit'])) {
    ...
    $editData = mysqli_fetch_assoc(
        mysqli_query($conn, "SELECT * FROM petugas WHERE id=$id")
    );
}
...
/* ======================
   DATA PETUGAS
====================== */
$dataPetugas = mysqli_query($conn, "SELECT * FROM petugas ORDER BY id DESC");
?>
    ...
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <div class="card">
                <form method="post">
                    ...
                    <?php if ($editData) { ?>
                        ...
                        <a href="petugas.php" class="action batal">Batal</a>
                    <?php } else { ?>
            ...
            <table>
                ...
                <?php $no = 1;
                while ($p = mysqli_fetch_assoc($dataPetugas)) { ?>
                    <tr>
                        <td><?= $no++ ?></td>

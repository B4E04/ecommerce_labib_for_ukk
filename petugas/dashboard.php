...
// FORMAT LOGIKA: Menambahkan Rp dan pemisah ribuan titik
        ...
        <script>
            ...
            const chartOptions = {
                ...
                elements: {
                    line: {
                        tension: 0.4
                    }, // Membuat garis melengkung (smooth)
                    point: {
                        radius: 0
                    } // Titik default disembunyikan
                }
            };

            // Inisialisasi Chart Pesanan
            ...
            function updateStats() {
                fetch('api_data.php')
                    ...
                    .then(data => {
                        ...
                        // --- Logika Hitung Persen Pengunjung ---
